...
const expectedCounts = {
  ...
  '10-free-inventory-web-apps-small-business': 6
};

console.log('=== COMPLETE 100% AUDIT FOR ALL 13 BLOG POSTS ACROSS ALL 11 LANGUAGES ===\n');
...
if (allPassed) {
  console.log(`🎉 ALL 13 BLOG POSTS ARE 100% COMPLETE AND VERIFIED ACROSS ALL 11 LANGUAGES! (${totalChecked} total language-post pairs verified)`);
} else {
