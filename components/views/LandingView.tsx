...
import { renderCreatorCredit, BUY_COFFEE_LABELS, PRODUCT_HUNT_LABELS } from '../common/GlobalFooter';
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-mono">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-16 space-y-10">
        ...
        <footer className="border-t border-slate-200 pt-8 space-y-6">
          ...
          <div className="border-t border-slate-200 pt-4 flex flex-col md:flex-row items-center justify-between text-xs text-slate-500 gap-4 font-mono">
            {/* Buttons: Buy Me a Coffee & Product Hunt */}
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-2.5">
              ...
              >
                ...
                <span>{BUY_COFFEE_LABELS[(settings?.language as SupportedLanguage) || 'en']}</span>
              </a>
              ...
              >
                ...
                <span>{PRODUCT_HUNT_LABELS[(settings?.language as SupportedLanguage) || 'en']}</span>
              </a>
            </div>

            {/* Translated Creator Attribution */}
            <div className="flex flex-col sm:flex-row items-center justify-center gap-2 text-[11px] text-slate-600 text-center">
              <div>{renderCreatorCredit((settings?.language as SupportedLanguage) || 'en')}</div>
